...
session_start();
    ...
    class Persons implements Table {
        ...
        public function displayListScreen() {
            echo "
                <div class='container'>
                    <div class='span10 offset1'>
                        <div class='row'>
						<br><br><a class='btn btn-primary' href='https://csis.svsu.edu/~djbenedi/cis355/TeeTyme/register/home.php'>Home Page</a>
                            <center><h3>Persons</h3>
                        </div>
                        <div class='row'>
							<center><a class='btn btn-primary' href='https://csis.svsu.edu/~djbenedi/cis355/TeeTyme/courses'>Add Course</a>
							<a class='btn btn-primary' href='https://csis.svsu.edu/~djbenedi/cis355/TeeTyme/rounds'>Add Round</a>
							<br><br>
							<center><a class='btn btn-primary' onclick='personsRequest(\"displayCreate\")'>Add Person</a>
							<br><br></center>
            ...
            foreach (Database::prepare('SELECT * FROM `persons`', array()) as $row) {
                echo "
                    <tr>
                        <td>{$row['name']  }</td>
                        <td>{$row['email'] }</td>
        ...
        public function createRecord() {
            if ($this->validate()) {
                Database::prepare(
                    "INSERT INTO persons (name, email, mobile) VALUES (?,?,?)",
        ...
        public function updateRecord() {
            if ($this->validate()) {
                Database::prepare(
                    "UPDATE persons SET name = ?, email = ?, mobile = ? WHERE id = ?",
